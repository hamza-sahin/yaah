...
## Thread Replies (GitHub / GitLab)

When replying to inline review comments, reply IN the comment thread, not as a top-level comment:
- GitHub: `gh api repos/{owner}/{repo}/pulls/{pr}/comments/{id}/replies -f body="…"`
- GitLab: `glab api -X POST "projects/:id/merge_requests/{mr}/discussions/{id}/notes" -f body="…"`
...
*Vendored into yaah from [obra/superpowers](https://github.com/obra/superpowers) (MIT), adapted for yaah (GitHub + GitLab thread replies; "the user" phrasing).*
